...
echo "=========================================="
echo "  NailFlow AI - Startup Script"
echo "=========================================="
echo ""
...
export NEXTAUTH_SECRET="${NEXTAUTH_SECRET:-nailflow-dev-secret-change-in-production}"
...
CLIENT_COUNT=$(psql "${DATABASE_URL}" -t -c "SELECT COUNT(*) FROM \"Client\";" 2>/dev/null | tr -d ' ' || echo "0")
...
echo ""
echo "=========================================="
echo "  Starting NailFlow AI on port ${APP_PORT}"
echo "=========================================="
echo ""
echo "Access the application at: http://localhost:${APP_PORT}"
echo ""
echo "Test credentials:"
echo "  Owner: linda@elegantnails.com / password123"
echo "  Manager: maria@elegantnails.com / password123"
echo "  Technician: kim@elegantnails.com / password123"
echo ""

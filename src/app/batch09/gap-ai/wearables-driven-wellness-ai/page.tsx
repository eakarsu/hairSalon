...
export default function WearablesDrivenWellnessAiPage() {
  ...
  const run = async () => {
    ...
    try {
      const r = await fetch('/api/gap-ai-beautywellnes/wearables-driven-wellness-ai', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Wearables-driven wellness AI</h1>

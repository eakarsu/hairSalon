...
export default function AiDrivenShiftFairnessOptimizationPage() {
  ...
  const run = async () => {
    ...
    try {
      const r = await fetch('/api/custom/ai-driven-shift-fairness-optimization', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>AI-driven shift fairness optimization</h1>

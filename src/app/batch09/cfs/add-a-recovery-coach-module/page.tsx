...
export default function AddARecoveryCoachModulePage() {
  ...
  const run = async () => {
    ...
    try {
      const r = await fetch('/api/custom/add-a-recovery-coach-module', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Add a recovery coach module</h1>

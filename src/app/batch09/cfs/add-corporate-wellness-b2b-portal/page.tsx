...
export default function AddCorporateWellnessB2bPortalPage() {
  ...
  const run = async () => {
    ...
    try {
      const r = await fetch('/api/custom/add-corporate-wellness-b2b-portal', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Add corporate-wellness B2B portal</h1>

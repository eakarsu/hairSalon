...
// Gap-ai endpoint: Wearables-driven wellness AI
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('wearables-driven-wellness-ai', body, out);
    return NextResponse.json({ feature: 'wearables-driven-wellness-ai', title: 'Wearables-driven wellness AI', result: out });
  } catch (err: any) {

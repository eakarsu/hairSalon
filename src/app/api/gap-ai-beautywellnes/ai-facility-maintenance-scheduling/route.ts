...
// Gap-ai endpoint: AI facility maintenance scheduling
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('ai-facility-maintenance-scheduling', body, out);
    return NextResponse.json({ feature: 'ai-facility-maintenance-scheduling', title: 'AI facility maintenance scheduling', result: out });
  } catch (err: any) {

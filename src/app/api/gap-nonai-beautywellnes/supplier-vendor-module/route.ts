...
// Gap-nonai endpoint: Supplier / vendor module
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('supplier-vendor-module', body, out);
    return NextResponse.json({ feature: 'supplier-vendor-module', title: 'Supplier / vendor module', result: out });
  } catch (err: any) {

...
// Gap-nonai endpoint: Wearables integration
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('wearables-integration', body, out);
    return NextResponse.json({ feature: 'wearables-integration', title: 'Wearables integration', result: out });
  } catch (err: any) {

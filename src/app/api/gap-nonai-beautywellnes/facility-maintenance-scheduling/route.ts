...
// Gap-nonai endpoint: Facility maintenance scheduling
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('facility-maintenance-scheduling', body, out);
    return NextResponse.json({ feature: 'facility-maintenance-scheduling', title: 'Facility maintenance scheduling', result: out });
  } catch (err: any) {

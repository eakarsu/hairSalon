...
// Gap-nonai endpoint: Marketplace listings
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('marketplace-listings', body, out);
    return NextResponse.json({ feature: 'marketplace-listings', title: 'Marketplace listings', result: out });
  } catch (err: any) {

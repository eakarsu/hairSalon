...
// Gap-nonai endpoint: QuickBooks / accounting integration
...
export async function POST(req: NextRequest) {
  try {
    ...
    await persist('quickbooks-accounting-integration', body, out);
    return NextResponse.json({ feature: 'quickbooks-accounting-integration', title: 'QuickBooks / accounting integration', result: out });
  } catch (err: any) {
